...
* добавление уведомлений о создании заказа, закрытии заказа и информации о доставке
* установлено время жизни уведомлений - 2 часа
* добавление этапа блокировки заказа (изменять заказ уже нельзя, но оплаты ещё не снялись)
