...
<?php
if (empty($items)) {
    echo '<p class="text-danger">Утеряна связь с КДВ! Обратитесь, пожалуйста, к администрации.</p>';
}
else {
    ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-center">
                            <? if ($order && $order->status == \app\models\Orders::STATUS_ACTIVE) : ?>
                                <?= Html::input('number', 'amount', $item['multiple'], [
                                    'min' => 1,
                                ...
                                <?= Html::a(
                                    ...
                                    [
                                        ...
                                        'onclick' => 'return addBasket("' . $item['kdv_url'] . '", ' . $order->id . ', "' . \yii\helpers\Url::to([
                                                '/orders/view/',
                                                'id' => $order->id
                                            ]) . '", ' . $item['id'] . ');'
                                    ]
    ...
    <?php if ($order && $order->status == \app\models\Orders::STATUS_ACTIVE) : ?>
        <script>
